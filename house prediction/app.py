...
st.subheader('Predict the price of a house based on its features')
...
sqft_living = st.sidebar.slider('Living Area (sqft)', 500, 10000, 2000)
...
if st.sidebar.button('Predict'):
    ...
    st.info("Prediction is based on the trained regression model.")
